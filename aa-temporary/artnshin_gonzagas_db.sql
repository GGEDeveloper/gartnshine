...
--
-- Host: localhost:3306
-- Tempo de geração: 16-Jul-2025 às 12:54
...
--
-- Estrutura da tabela `database_migrations`
--
...
--
-- Extraindo dados da tabela `database_migrations`
--
...
--
-- Estrutura da tabela `inventory_movements`
--
...
--
-- Estrutura da tabela `product_price_history`
--
...
--
-- Extraindo dados da tabela `product_price_history`
--
...
--
-- Estrutura da tabela `product_pricing`
--
...
--
-- Estrutura da tabela `product_purchases`
--
...
INSERT INTO `site_settings` (`id`, `featured_carousel_enabled`, `catalog_page_enabled`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2025-06-01 15:08:28', '2025-06-02 15:43:12');
...
--
-- Índices para tabela `database_migrations`
--
...
--
-- Índices para tabela `inventory_transactions`
--
...
--
-- Índices para tabela `product_price_history`
--
...
--
-- Índices para tabela `product_pricing`
--
...
--
-- Índices para tabela `product_purchases`
--
...
--
-- AUTO_INCREMENT de tabela `database_migrations`
--
ALTER TABLE `database_migrations`
...
--
-- AUTO_INCREMENT de tabela `product_price_history`
--
ALTER TABLE `product_price_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;

--
-- AUTO_INCREMENT de tabela `product_pricing`
--
ALTER TABLE `product_pricing`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Limitadores para a tabela `inventory_movements`
--
ALTER TABLE `inventory_movements`
