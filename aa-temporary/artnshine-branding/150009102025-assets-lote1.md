...
```bash
# 1. Criar o script
nano scripts/download-lote1-dark-nature.py

# 2. Copiar código acima para o ficheiro

# 3. Tornar executável
chmod +x scripts/download-lote1-dark-nature.py

# 4. Executar download
python3 scripts/download-lote1-dark-nature.py

# 5. Verificar assets descarregados
ls -la public/gallery/dark-nature/
```
...
└── gallery/
    └── dark-nature/
        ├── hero/
        │   └── caverna-primordial-hero.jpg (~280KB)
        ├── transformacao/
        │   ├── prata-abracando-onix.jpg (~310KB)
        │   └── bancada-artesao-penumbra.jpg (~290KB)
        └── natureza/
            └── quaternario-natural-organic.jpg (~270KB)
```

## **Total**: ~1.1MB de assets autênticos Dark Nature!

**Execute o script e em 30 segundos terá os 4 primeiros assets organizados!**

**Depois criamos o Lote 2 com os próximos 4 assets!** 🌑💎⚒️🍃