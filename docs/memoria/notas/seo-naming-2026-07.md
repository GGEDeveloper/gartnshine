...
- **Desactualizado a partir de 2026-07-30** (ver [[seo-audit-2026-07-30]]): o sufixo " | Art&Shine" passou a ser condicional (só entra se o título couber em ~60 chars) e a meta-description já não é o corte simples da `description` — descrições curtas são completadas com material, família e contexto.
